...
import {FxIndexSnapshot, FxIndexSnapshotCollection} from '../model/fx.model';

@Component({
  selector: 'app-fx-index-quick-search',
    imports: [
      FormsModule,
    ],
  templateUrl: './fx-index-quick-search.component.html',
  styleUrl: './fx-index-quick-search.component.scss'
})
export class FxIndexQuickSearchComponent {
  ...
  onSearch() {
    ...
    let subscription = this.fxIndexService.findFxIndices(selectionCriteria, 0, 100).subscribe({
  ...
  private populateListBox(collection : FxIndexSnapshotCollection) {
  ...
  private convertToSearchModel(snapshot: FxIndexSnapshot) : SearchColumnModel {
