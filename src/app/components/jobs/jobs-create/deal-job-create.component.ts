...
@Component({
  ...
  templateUrl: './deal-job-create.component.html',
  styleUrl: './deal-job-create.component.scss'
})
export class DealJobCreateComponent {
  ...
  formTypeCode = computed<'Generation' | 'Valuation'>( () => {
    if (this.jobTypeCode() === 'DealPositionGeneration' )
      return 'Generation'
    else
      return 'Valuation'});
